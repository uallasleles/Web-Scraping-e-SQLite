...
## Conclusão
Criei uma sequencia de código para extrair dados de uma página web, então salvei estes dados em um banco de dados SQLite chamado 'proj_20210623.db'.
Podemos então recuperar estes dados para análise, ou podemos dar sequencia utilizando linguagem SQL para gerar consultarmos, gerarmos relatórios, procedimentos, agregação com outros conjuntos de dados, transferí-los para outras pessoas, etc.
